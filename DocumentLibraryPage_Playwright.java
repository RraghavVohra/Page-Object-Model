// ============================================================
// PAGE OBJECT CLASS — Document Library
...
public class DocumentLibraryPage {
    ...
    public DocumentLibraryPage(Page page) {
        this.page = page;
        // NOTE: No WebDriverWait needed here.
        // Playwright has built-in auto-waiting on every action.
    }
    ...
    public static final String PDF_FILE   = "C:/TestFiles/test.pdf";
    public static final String PNG_FILE   = "C:/TestFiles/test.png";
    public static final String JPG_FILE   = "C:/TestFiles/test.jpg";
    public static final String CSV_FILE   = "C:/TestFiles/test.csv";
    public static final String XLSX_FILE  = "C:/TestFiles/test.xlsx";
    public static final String MP4_FILE   = "C:/TestFiles/test.mp4";
    public static final String GIF_FILE   = "C:/TestFiles/test.gif";

    public static final String THUMBNAIL_PNG = "C:/TestFiles/thumbnail.png";
    public static final String THUMBNAIL_GIF = "C:/TestFiles/thumbnail.gif";
    public static final String THUMBNAIL_JPG = "C:/TestFiles/thumbnail.jpg";
    ...
    private Locator communicationTab()      { return page.locator("//span[text()='Communication']"); }
    private Locator documentLibraryLink()   { return page.locator("(//a[@class='dropdown-item'])[5]"); }
    private Locator actionsButton()         { return page.locator("(//*[name()='svg'])[1]"); }
    private Locator profileIcon()           { return page.locator("//i[@class='fa fa-user-circle']"); }
    private Locator logOutOption()          { return page.locator("//a[normalize-space()='Log Out']"); }
    private Locator logoutButtonPrimary()   { return page.locator("//a[normalize-space()='Yes' and contains(@class,'btn-primary')]"); }
    private Locator logoutButtonYes()       { return page.locator("//a[normalize-space()='Yes']"); }
    private Locator uploadOption()          { return page.locator("//a[@href='sp-upload-document.php']"); }
    private Locator uploadButton()          { return page.locator("//input[@id='share_button']"); }
    private Locator documentNameField()     { return page.locator("//input[@id='document_name']"); }
    private Locator fileInput()             { return page.locator("#document_file"); }
    private Locator thumbnailInput()        { return page.locator("#img_validate"); }
    private Locator croppingHandle()        { return page.locator("//div[@class='imgareaselect-border4']"); }
    private Locator applyButton()           { return page.locator("//a[@class='btn yes yellow-gold pull-right']"); }
    private Locator descriptionField()      { return page.locator("//textarea[@class='form-control h150']"); }
    private Locator documentOptionTwo()     { return page.locator("//input[@value='2']"); }
    private Locator documentOptionThree()   { return page.locator("//input[@value='3']"); }
    private Locator downloadableToggle()    { return page.locator("//span[@class='bootstrap-switch-handle-off bootstrap-switch-default']"); }
    private Locator hashtagField()          { return page.locator("//input[@id='tagcsv']"); }
    private Locator hashtagSuggestion()     { return page.locator("//li[@class='ui-menu-item']"); }
    private Locator searchBox()             { return page.locator("//input[@type='search' and @placeholder='Search']"); }
    private Locator searchResult()          { return page.locator("//td[normalize-space()='ewewew test']"); }
    private Locator deleteOption()          { return page.locator("#Delete3"); }
    private Locator okButton()              { return page.locator("//button[@type='button' and @class='btn btn-primary bootbox-accept' and text()='OK']"); }
    private Locator dialogBox()             { return page.locator("//div[@class='bootbox-body']"); }
    private Locator checkboxOption()        { return page.locator("(//input[@id='document_content'])[1]"); }
    private Locator dynamicElement()        { return page.locator("(//td[@class='wBreak d-none d-md-table-cell' and @style='cursor: no-drop;'])[1]"); }
    private Locator noRecordsElement()      { return page.locator("//td[@class='dataTables_empty' and text()='No matching records found']"); }
    private Locator accessOption()          { return page.locator("//a[@id='add_synd']"); }
    private Locator teamRadioButton()       { return page.locator("//input[@id='partners_option']"); }
    private Locator partnerCategoryButton() { return page.locator("//button[@id='btn_ptr_category']"); }
    private Locator categoryLabel()         { return page.locator("//label[@for='ms-opt-40']"); }
    private Locator updateAccessButton()    { return page.locator("//input[@id='synd_update_id']"); }
    private Locator scheduleCheckbox()      { return page.locator("//input[@id='schedule']"); }
    private Locator scheduleTextbox()       { return page.locator("//input[@id='schedule_synd']"); }
    private Locator contentUpdateDate()     { return page.locator("//input[@id='start_date' and @name='start_date' and @type='text']"); }
